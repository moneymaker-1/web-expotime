...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'descriptionAr', title: 'الوصف (عربي)', type: 'text', initialValue: 'إكسبو تايم شركة رائدة في تصميم وتنفيذ أجنحة المعارض منذ 2005' }),
    defineField({ name: 'descriptionEn', title: 'Description (English)', type: 'text', initialValue: 'Expo Time is a leading exhibition stand design and fabrication company since 2005' }),
