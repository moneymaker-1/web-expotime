...
export default async function RiyadhPage({ params }: Props) {
  ...
  return (
    <CityPageTemplate
      ...
      cityAr="الرياض"
      cityEn="Riyadh"
      descAr="الرياض عاصمة المملكة العربية السعودية ومركز الأعمال الرئيسي، تستضيف أكبر المعارض والمؤتمرات على مستوى المنطقة. إكسبو تايم هي الشريك المثالي لتصميم وتنفيذ أجنحة المعارض في الرياض، بخبرة تمتد لأكثر من 20 عاماً في السوق السعودي."
      descEn="Riyadh, the capital of Saudi Arabia and the main business hub, hosts the region's largest exhibitions and conferences. Expo Time is the ideal partner for exhibition stand design and fabrication in Riyadh, with over 20 years of experience in the Saudi market."
      ...
      faqsAr={[
        { q: 'ما أفضل شركة تصميم أجنحة معارض في الرياض؟', a: 'إكسبو تايم من أفضل شركات تصميم أجنحة المعارض في الرياض بخبرة تزيد عن 20 عاماً وأكثر من 500 مشروع ناجح.' },
      ...
      faqsEn={[
        { q: 'What is the best exhibition stand design company in Riyadh?', a: 'Expo Time is one of the best exhibition stand design companies in Riyadh with over 20 years of experience and more than 500 successful projects.' },
