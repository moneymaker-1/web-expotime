  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        backgroundImage: 'linear-gradient(rgba(243, 199, 22, 0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(243, 199, 22, 0.04) 1px, transparent 1px)',
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(243, 199, 22, 0.12) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
          ...
          <div style={{ order: isRtl ? 2 : 1 }}>
            ...
            <div style={{
              ...
              background: 'rgba(243, 199, 22, 0.12)',
              border: '1px solid rgba(243, 199, 22, 0.3)',
              borderRadius: '9999px',
              marginBottom: '1.75rem',
            }}>
              <span style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: '#f3c716', display: 'inline-block' }} />
              <span style={{ color: '#f3c716', fontSize: '0.875rem', fontWeight: 600 }}>{t('badge')}</span>
            </div>

            {/* Headline */}
            <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 900, lineHeight: 1.1, marginBottom: '1.5rem', color: '#F9FAFB' }}>
              {t('title')}{' '}
              <span style={{ color: '#f3c716', display: 'block' }}>{t('titleHighlight')}</span>
            </h1>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '3rem' }}>
              <Link href={`/${locale}/contact`} style={{
                ...
                boxShadow: '0 4px 20px rgba(243, 199, 22, 0.3)',
              }}>
              ...
              <Link href={`/${locale}/portfolio`} style={{
                ...
                color: '#f3c716', fontWeight: 700, fontSize: '1rem',
                borderRadius: '0.625rem', textDecoration: 'none',
            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              {[
                ...
                <div key={s.num}>
                  <div style={{ fontSize: '1.75rem', fontWeight: 900, color: '#f3c716', lineHeight: 1 }}>{s.num}</div>
          ...
          <div style={{ order: isRtl ? 1 : 2, position: 'relative' }}>
            <div style={{
              ...
              <div style={{
                ...
                background: 'rgba(243, 199, 22, 0.95)',
                borderRadius: '0.75rem', padding: '0.75rem 1.25rem',
                backdropFilter: 'blur(10px)',
              }}>
                <div style={{ fontSize: '1.5rem', fontWeight: 900, color: '#0f1e2d', lineHeight: 1 }}>500+</div>
                <div style={{ fontSize: '0.75rem', color: '#0f1e2d', fontWeight: 700 }}>
            ...
            <div style={{
              ...
              width: 80, height: 80,
              border: '2px solid rgba(243, 199, 22, 0.3)',
              borderRadius: '50%',
              zIndex: -1,
            }} />
          </div>
...
function StatsSection({ locale }: { locale: string }) {
  ...
  return (
    <section style={{ backgroundColor: '#0a1520', padding: '3rem 0', borderTop: '1px solid rgba(243,199,22,0.1)', borderBottom: '1px solid rgba(243,199,22,0.1)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '2rem' }}>
          {stats.map(({ num, labelAr, labelEn, Icon }) => (
            <div key={num} style={{ textAlign: 'center', padding: '1.5rem' }}>
              ...
              <div style={{ fontSize: '2.5rem', fontWeight: 900, color: '#f3c716', lineHeight: 1 }}>{num}</div>
          ...
          {services.map((s) => (
            <Link key={s.slug} href={`/${locale}/${s.slug}`} style={{ textDecoration: 'none' }}>
              <div className="card" style={{ padding: '2rem', height: '100%', cursor: 'pointer' }}>
                ...
                <div style={{ marginTop: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.375rem', color: '#f3c716', fontSize: '0.875rem', fontWeight: 600 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '1rem' }}>
          {clients.map((c) => (
            <div key={c.nameEn} style={{
              ...
              <div style={{ width: 44, height: 44, borderRadius: '0.5rem', background: 'rgba(243,199,22,0.1)', margin: '0 auto 0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.25rem' }}>
                🏢
              </div>
            ...
            <div key={tm.nameEn} className="card" style={{ padding: '2rem' }}>
              <div style={{ display: 'flex', gap: '0.25rem', marginBottom: '1.25rem' }}>
                {Array.from({ length: tm.rating }).map((_, i) => (
                  <Star key={i} size={16} fill="#f3c716" style={{ color: '#f3c716' }} />
                ))}
              </div>
...
function CTASection({ locale }: { locale: string }) {
  ...
  return (
    <section style={{ padding: '5rem 0', background: 'linear-gradient(135deg, #0f1e2d 0%, #1a1208 50%, #0f1e2d 100%)' }}>
      <div className="container-custom" style={{ textAlign: 'center' }}>
        <div style={{
          background: 'linear-gradient(135deg, rgba(243,199,22,0.12), rgba(243,199,22,0.04))',
          ...
          <div style={{
            ...
            width: 600, height: 600,
            background: 'radial-gradient(circle, rgba(243,199,22,0.08) 0%, transparent 70%)',
            pointerEvents: 'none',
          }} />
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', position: 'relative' }}>
            <Link href={`/${locale}/contact`} style={{
              ...
              padding: '1rem 2.5rem',
              background: 'linear-gradient(135deg, #f3c716, #d4a800)',
              color: '#0f1e2d', fontWeight: 800, fontSize: '1.05rem',
              borderRadius: '0.625rem', textDecoration: 'none',
              boxShadow: '0 8px 25px rgba(243,199,22,0.4)',
            }}>
