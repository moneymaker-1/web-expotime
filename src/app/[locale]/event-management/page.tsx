...
export default async function EventManagementPage({ params }: Props) {
  ...
  return (
    <ServicePageTemplate
      ...
      descAr="إدارة الفعاليات فن وعلم في آنٍ واحد. في إكسبو تايم، نمتلك الأدوات والخبرة والشغف اللازمة لتحويل رؤيتك إلى فعالية استثنائية تترك أثراً عميقاً في ذاكرة الحضور. منذ 2015، نفّذنا أكثر من 5000 فعالية لعملاء من القطاعين الحكومي والخاص في مختلف مدن المملكة. فريقنا يضم مديري فعاليات معتمدين، ومنسقي لوجستيك متخصصين، ومبدعين في تصميم التجارب البصرية والحسية. نتعامل مع كل فعالية باعتبارها مشروعاً فريداً يستحق أفضل ما لدينا."
      descEn="Event management is both an art and a science. At Expo Time, we have the tools, experience, and passion to transform your vision into an exceptional event that leaves a lasting impression on attendees. Since 2015, we have executed over 5000 events for clients from both the government and private sectors across various Saudi cities. Our team includes certified event managers, specialized logistics coordinators, and creative professionals in visual and sensory experience design. We treat every event as a unique project that deserves our very best."
      featuresAr={[
